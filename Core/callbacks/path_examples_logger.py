            ...
            for batch_idx, batch in enumerate(val_dataloader):
                ...
                try:
                    ...
                    if hasattr(pl_module.model, 'generate_multiple'):
                        ...
                        pred_relations = torch.stack(pred_relations_list, dim=1)
                        pred_entities = torch.zeros(pred_relations.shape[0], pred_relations.shape[1], pred_relations.shape[2], dtype=torch.long)
